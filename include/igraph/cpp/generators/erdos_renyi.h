...
Graph erdos_renyi_game_gnm(integer_t n, integer_t m, bool directed = false, bool loops = false);

/// Generates an Erdos-Renyi random network with the G(n, p) model
Graph erdos_renyi_game_gnp(integer_t n, real_t p, bool directed = false, bool loops = false);
