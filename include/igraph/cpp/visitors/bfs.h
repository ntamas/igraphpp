...
void bfs(const Graph& graph, integer_t root, VectorInt* roots=0,
        ...
        VectorInt* restricted=0, VectorInt* order=0, VectorInt* rank=0,
        VectorInt* father=0, VectorInt* pred=0, VectorInt* succ=0,
        VectorInt* dist=0, BFSHandler callback=0, void* extra=0);
