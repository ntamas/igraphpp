...
void bfs(const Graph& graph, integer_t root, Vector* roots=0,
        NeighborMode mode=IGRAPH_OUT, bool unreachable=false, Vector* restricted=0,
        Vector* order=0, Vector* rank=0, Vector* father=0,
        Vector* pred=0, Vector* succ=0, Vector* dist=0,
